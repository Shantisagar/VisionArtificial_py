...
if __name__ == "__main__":
    try:
        ...
        altura2 = float(input(f'Ingrese la segunda altura para corregir el eje vertical, "{config["horizontal_default"]}" por defecto): ') or config["horizontal_default"])
        ...
        root = tk.Tk()
        app = VideoStreamApp(root, default_video_url, grados_rotacion, altura, perspectiva_default, altura2)
        app.run()
    except Exception as e:
