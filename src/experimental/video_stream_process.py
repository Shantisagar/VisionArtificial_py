...
class VideoStreamProcessApp:
    ...
    def __init__(self, root, video_source=0, logger=None):
        ...
        self.capture_process = mp.Process(
            ...
            args=(self.frame_queue, self.command_queue, self.stats_queue, self.running, self.video_source)
        )
                    ...
                    if not frame_queue.full():
                        ...
                        if frames_processed % 10 == 0:
                            stats = {
                                ...
                                'fps_current': 1.0 / (now - last_frame_time) if now > last_frame_time else 0,
